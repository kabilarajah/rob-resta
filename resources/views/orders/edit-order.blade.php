                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                    <a href="{{ route('product.show',['id'=> $product['item']['id']]) }}" target="_blank"> {{$product['item']['title']}} </a>   
                                                ...
                                                <p></p>
                                                <p>
                                                <a href="{{ route('order.index') }}" class="btn btn-primary" role="button" target="_blank"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
{{--                                              <tr>
                                            ...
                                            <tr>
                                                <th colspan="3"></th>
                                                <th colspan="1"><h4>Total Rs.{{$order->total}}</h4></th>
                                            </tr>
                                        </tfoot>
                            ...
                            <form action="/orders/{{ $order->id }}" method="post">
                                ...
                                <div class="input-group col-md-6">
                                    ...
                                    <span><label for="validate-text">Customer Name</label><input type="text" name="name" class="form-control" value="{{$order->name}}" required placeholder="Customer Name"></span><hr>
                                    <span><label for="validate-text">Table Number</label><input type="number" name="table" min="1" max="5" value="{{$order->table}}" required class="form-control" placeholder="Table Number"></span>
                     ...
                     <div class="pull-left">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button type="submit" class="btn btn-dark"> <i class="fa fa-cutlery" aria-hidden="true"></i>  Done Editing
                                        </button>
                                    </div>
                                </div>
                            </form>
